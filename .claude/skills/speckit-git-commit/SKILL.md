...
Commits created by this skill (and any manual Spec Kit follow-up commits) **SHOULD** follow [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/).
...
**Body (optional):** after a blank line, add context such as Spec Kit task IDs or design notes:
